...
<body>
	<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		...
		<!-- System info -->
		<a class="btn btn-success" href="${context}/systeminfo" target="_new" 
			role="button">Load</a>&nbsp;&nbsp;&nbsp;


		<form class="form-inline mt-2 mt-md-0" method="POST"
		action="${context}/search"><input class="form-control mr-sm-2"
	...
	<div class="container-fluid" style="top: 80px; position: absolute;">
		...
		style="top:80px;position: absolute;"--> <!-- JUMBOTRON --> <!--div class="jumbotron">
