...
-- boxes
INSERT INTO BOX (BOX_ID, BOX_KEY, BOX_NAME, BOX_TYPE, BOX_VIEW, BOX_CREATED_DATETIME, BOX_LAST_KEY, THINGTYPESCHEMA_TTS_ID ) 
	VALUES (1, 'POO', 'My secret things (DEMO)', 1, 'cards', NOW(), 23, 1); 
INSERT INTO BOX (BOX_ID, BOX_KEY, BOX_NAME, BOX_VIEW, BOX_CREATED_DATETIME, BOX_LAST_KEY, THINGTYPESCHEMA_TTS_ID ) VALUES (2, 'SCRUM', 'Developing with agile methodologies (DEMO)', '', NOW(), 2, 2); 
INSERT INTO BOX (BOX_ID, BOX_KEY, BOX_NAME, BOX_VIEW, BOX_CREATED_DATETIME, BOX_LAST_KEY, THINGTYPESCHEMA_TTS_ID ) VALUES (3, 'DESK', 'Service Desk Box (DEMO)', '', NOW(), 2, 3); 
INSERT INTO BOX (BOX_ID, BOX_KEY, BOX_NAME, BOX_VIEW, BOX_CREATED_DATETIME, BOX_LAST_KEY, THINGTYPESCHEMA_TTS_ID ) VALUES (4, 'PHOTO', 'Photo Box', 'photo', NOW(), 1, 4); 
